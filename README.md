...
Epic Games Store, Steam ve GOG'da ücretsiz dağıtılan oyunları 5 dakikada bir
...
3. *Actions* sekmesinden workflow'u etkinleştir. 5 dakikada bir kendi çalışır (GitHub yoğunlukta atlayabilir);
